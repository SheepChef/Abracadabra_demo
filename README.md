...
[<img src="https://img.shields.io/badge/核心源码仓库-4c00fc?style=for-the-badge" width="120" />](https://github.com/SheepChef/Abracadabra)
...
你正在查阅魔曰的前端源代码仓库，此仓库用于维护魔曰的网页应用程序和浏览器插件源码。
...
> ### 您是资深用户？
>
> 如果您是资深用户，想要自行部署或者编译本项目，推荐您直接查阅文档。
>
> 请查阅 [**前端编译和部署**](https://abracadabra.js.org/document/frontend-deploy.html) 一节，了解编译步骤。
>
...
如果你想自行快速部署这个静态页，可以在Release中下载快速部署文件包。
